...
class ContainerDetection(models.Model):
    ...
    truck_id = models.BigIntegerField(default=0)
    ...
    roi_name = models.CharField(max_length=32, blank=True, default="", null=True)
    ...
    ocr_texts = models.JSONField(default=list, blank=True, null=True)
