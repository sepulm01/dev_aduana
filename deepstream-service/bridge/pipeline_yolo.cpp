...
void PipelineYolo::create_inference(AppCtx& appctx, guint batch_size)
{
...
void PipelineYolo::link_inference(AppCtx& appctx, GstElement* src,
                                   GstElement* tracker, GstElement* qt)
{
    ...
    if (!gst_element_link_many(
        ...
        g_printerr("PipelineYolo link failed. Exiting.\n");
    }
}
